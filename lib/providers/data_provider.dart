...
import 'textfields/age_textfield.dart';

final diagonsisDataProvider = FutureProvider<List<SymptomsModel>>((ref) async {
  return ref.watch(diagonsisProvider).getDiagnosis(ref.watch(genderProvider),
      ref.watch(ageProvider), ref.watch(symptomNameProvider));
});
